                ...
                <div className="mt-8">
                    <form onSubmit={formik.handleSubmit} action="#" autoComplete="on">
                        ...
                        <div className="flex w-full">
                            <button type="submit"
                                    className="py-2 px-4  bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-auto transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ">
                                Login
                            </button>
                        </div>
                    </form>
